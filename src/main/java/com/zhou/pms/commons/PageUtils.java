...
public class PageUtils {
	...
	public PageUtils(Integer currpage, Integer pagesize, Long totalrecord, Integer navnum) {
		...
		//计算结束行
		this.setEndtrow(currpage*pagesize);
	}
	...
	public static void main(String[] args) {
		PageUtils page=new PageUtils(2, 10, 580l, 10);
	...
	public String toString() {
		return "PageUtils [currpage=" + currpage + ", totalpage=" + totalpage
				+ ", pagesize=" + pagesize + ", totalrecord=" + totalrecord
				+ ", navnum=" + navnum + ", startnav=" + startnav + ", endnav="
				+ endnav + ", list=" + list + ", startrow=" + startrow
				+ ", endtrow=" + endtrow + "]";
	}
